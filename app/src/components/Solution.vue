  ...
  <div class="bg-blue-950 text-center">
    ...
    >
      <div class="bg-blue-950">
        ...
        ><span
          class="text-gray-400 font-bold text-3xl sm:text-4xl md:text-5xl lg:text-6xl"
          >Digital <br />Solutions</span
        ><br /><span
          class="font-normal text-white text-base sm:text-xl lg:text-xl xl:text-xl"
          ><br />
          ...
          technologies, and passion for innovation, we are <br />committed to
          delivering exceptional results for every project we undertake. From
          captivating web design that leaves <br />a lasting impression to
          seamless web development that ensures optimal functionality, we cover
