    ...
    >
      <div class="team-member w-72 relative overflow-hidden">
        ...
        >
          ...
          <div class="social-links flex mt-2">
            <a href="https://github.com/joe052" target="_blank" class="mr-2">
      ...
      <div class="team-member w-72 relative overflow-hidden">
        ...
        >
          ...
          <div class="social-links flex mt-2">
            <a
              href="https://github.com/immanuel4082"
              target="_blank"
              class="mr-2"
            >
              <img src="@/assets/github.png" alt="GitHub" class="w-6 h-6" />
      ...
      <div class="team-member w-72 relative overflow-hidden">
        ...
        >
          ...
          <p class="font-medium">Experience: 5 years</p>
          <div class="social-links flex mt-2">
            <a href="https://github.com/NellitG" target="_blank" class="mr-2">
              <img src="@/assets/github.png" alt="GitHub" class="w-6 h-6" />
            </a>
            <!-- Add other social links here -->
          </div>
      ...
      <div class="team-member w-72 relative overflow-hidden">
        ...
        >
          ...
          <p class="font-medium">Experience: 5 years</p>
          <div class="social-links flex mt-2">
            <a href="https://github.com/2claire" target="_blank" class="mr-2">
              <img src="@/assets/github.png" alt="GitHub" class="w-6 h-6" />
            </a>
            <!-- Add other social links here -->
          </div>
